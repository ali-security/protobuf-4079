...
pub trait MessageBackendInterop:
    AssociatedMiniTable + UpbGetArena + UpbGetMessagePtr + UpbGetMessagePtrMut
{
}
impl<T: AssociatedMiniTable + UpbGetArena + UpbGetMessagePtr + UpbGetMessagePtrMut>
    MessageBackendInterop for T
{
}

pub trait MessageViewBackendInterop: UpbGetMessagePtr {}
impl<T: UpbGetMessagePtr> MessageViewBackendInterop for T {}

pub trait MessageMutBackendInterop: UpbGetMessagePtr + UpbGetMessagePtrMut {}
impl<T: UpbGetMessagePtr + UpbGetMessagePtrMut> MessageMutBackendInterop for T {}
